...
> **Note** For normal user who is not a developer, click  <a href="https://github.com/zenoftech/CPP/blob/main/fahrenheit_to_Celsius.exe" download>here</a> to download the executable file and run it in your pc.
